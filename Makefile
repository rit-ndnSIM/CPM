CC=g++
CFLAGS=-Wall -Weffc++ -Wextra -Wconversion -Wsign-conversion -Wshadow -pedantic -lboost_json -lboost_graph -lboost_program_options -fdiagnostics-all-candidates -std=c++17
DFLAGS=-ggdb
